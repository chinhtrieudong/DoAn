...
const floppyAddress = "0xE37AbEb5C26fA8BF27b808d82f282825d64ff894";
myPrivateKey = process.env.PRIV_KEY;
myAddress = "0xefCd6593aAF3A0D2DEb01eD0584Cd2Ad0f9D2c75";
receiverAddress = "0xA03a771B9d4D36b05f28aAF6edD18A5730cf62C1";
...
async function interact() {
    ...
    rs = await floppyContract.methods.transfer(receiverAddress, 100000).send({
        from: myAddress,
        gasPrice: web3.utils.toWei('0.000000005', 'ether'), // Đặt mức giá gas
        gas: 3000000 // Đặt mức gas
    });
